 ...
 */
package com.softwareag.mediator.server.auth;
...
/**
 * Based on the jersey https-clientserver-grizzly sample
 */
public class SecurityFilter implements ContainerRequestFilter {
    ...
    private User authenticate(ContainerRequest request) {
        ...
        if (!authentication.startsWith("Basic ")) {
            System.out.println("No BASIC Auth header found! Cannot authenticate user!");
            return null;
